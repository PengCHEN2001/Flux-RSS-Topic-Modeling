...
if __name__ == "__main__":
    ...
    parser.add_argument("output_file", type=Path, help="Chemin du fichier de sortie")
    
    parser.add_argument("--format-in", choices=["xml", "json", "pickle"], required=True, help="Format du fichier d'entrée")
    parser.add_argument("--format-out", choices=["xml", "json", "pickle"], required=True, help="Format du fichier de sortie")
